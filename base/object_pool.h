...
#ifndef IROS_BASE_OBJECT_POOL_H_
#define IROS_BASE_OBJECT_POOL_H_
...
{
    if (iros_unlikely(object == nullptr)) { return; }
...
{
    if (iros_unlikely(free_head_ == nullptr)) { return nullptr; }
...
#endif   // IROS_BASE_OBJECT_POOL_H_
